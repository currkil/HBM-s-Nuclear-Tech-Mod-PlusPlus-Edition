...
import currkill.hbms_ntm_pp.block.machine.modMachines;
...
/**
 * 集中存放方块、物品与方块实体的延迟注册器
 * <p>各注册类中的流式构造器最终都写到这里，因此注册只需调用一次{@link #register_all(IEventBus)}</p>
 */
public class modDeferredRegisters {
    ...
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITY =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, Hbms_ntm_pp.MODID);
