 ...
 * </ul>
 * <p><b>尚未移植：</b>依赖未移植系统的几个网络提供器 ——
 * <ul>
 *   <li>{@code PowerNetProvider}，依赖能量网络 {@code api.hbm.energymk2.PowerNetMK2}</li>
 *   <li>{@code FluidNetProvider}，依赖流体网络 {@code api.hbm.fluidmk2.FluidNetMK2}</li>
 *   <li>{@code PneumaticNetworkProvider}，依赖气动系统与物品管理的一批类</li>
 * </ul>
 * 这些将在各自系统移植后补进 {@code api.uninos.networkproviders}。
 * </p>
